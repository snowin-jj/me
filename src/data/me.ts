export default {
    ...
    name: 'snowin',
    full_name: 'Snowin J',
    job_title: 'FullStack Developer (ReacJS/NodeJS)',
    ...
    side_projects: [
        {
            id: 'ad356d3f-8000-494d-af00-543423133c4b',
            title: 'Zipy',
            url: 'https://zipy.live',
            short_desc:
                'Zipy is a link management app that lets you manage all of your social media links in one place.',
            long_desc:
        ...
        {
            id: '7dc0f8b2-54dc-49d1-88c7-b294e2eef2e3',
            title: 'DevMailer',
            url: 'https://devmailer.vercel.app',
            short_desc:
                'Dev Mailer is an API service designed to assist developers. It incorporates a mail service into your website.',
            long_desc:
    ...
    projects: [
        {
            id: '87a1dcca-f5f8-4d5a-99a3-96274622bc12',
            title: 'Galeria',
            url: 'https://galeria.devsnow.in',
            short_desc:
                'An image gallery app where you can discover amazing images. Made with React and styled with tailwindcss.',
            long_desc:
                'An image gallery app where you can discover amazing images. Made with React and styled with tailwindcss.',
        },
        {
            id: '2fcfe113-8819-4c30-b6e9-bd1675df3306',
            title: 'Useful Links',
            url: 'https://usefullinks.vercel.app',
            short_desc: null,
            long_desc: null,
        },
        {
            id: '6d3e5fed-d8c3-46e5-9160-19650ab49bcf',
            title: 'Cookz',
            url: 'https://cookz.vercel.app',
            short_desc: null,
            long_desc: null,
        },
        {
            id: '5781ac6f-6462-40f1-8b0f-5d3c1023761d',
            title: 'Travello',
            url: 'https://app-travello.vercel.app',
            short_desc: null,
            long_desc: null,
        },
    ],
